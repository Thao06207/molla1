...
var forgotPasswordEmail  = document.getElementById('forgot_password')


function Sendsubmit() { 
	  axios.post(baseUrl + '/beauty/auth/forgot-password', {
		   email: forgotPasswordEmail.value,
		   }) 
		   .then(function(response) {
			    Swal.fire({ 
					title: 'Thông báo gửi mail', 
					text: response.data, icon: 'success', 
